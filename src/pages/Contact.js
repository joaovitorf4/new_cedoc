      ...
      <main style={style}>
        ...
        <div id="main-div-contacts">
          <div className="div-contacts">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#00000" className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
          ...
          <div className="div-contacts">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#00000" className="bi bi-envelope-fill" viewBox="0 0 16 16">
          ...
          <div className="div-contacts">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#00000" className="bi bi-telephone-fill" viewBox="0 0 16 16">
          ...
          <div className="div-contacts">
            <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#00000" className="bi bi-whatsapp" viewBox="0 0 16 16">
