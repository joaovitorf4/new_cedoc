      ...
      >
        <main>
          ...
          <div id="main-div-services">
            <div>
              <Link to="/gestao-de-documentos">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#fff" className="bi bi-file-earmark-text" viewBox="0 0 16 16">
                  <path d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5"/>
                  <path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
                </svg>
                <Paragraph>Gestão de Documentos</Paragraph>
              </Link>
            </div>
            <div>
              <Link to="/sistema-rh-digital">
            ...
            <div>
              <Link to="/extrator-de-textos-ocr">
                ...
                <Paragraph>BPO - Terceirização de Perocessos</Paragraph>
              </Link>
            </div>
            <div>
              <Link to="/digitalizar">
